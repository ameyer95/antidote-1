...
enum class UCINames { IRIS, CANCER, WINE, YEAST, RETINOPATHY, MAMMOGRAPHY, ADULT_INCOME, GERMAN_LOAN, COMPAS };
...
// this is the fuzz testing version - delete later!!
const UCIDetails UCI_ADULT_INCOME_DETAILS = {"fuzz.data", "adult_income.test", 17, 14, {15,16}, 48842 };
